...
The RMPP provides a large number of features and visual tools for motion planning. Using Rviz and RMPP, visualizations such as seen in Figure \ref{fig:motion_plan} are provided of:
...
\caption{Total code contributors to MoveIt across all repositories. TODO cleanup diagram, add titles and axis labels, replace with total code amount}
